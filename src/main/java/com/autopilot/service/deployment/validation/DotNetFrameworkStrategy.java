...
public class DotNetFrameworkStrategy implements FrameworkStrategy {
    private final ServiceConfig service;

    public DotNetFrameworkStrategy(ServiceConfig service) {
        this.service = service;
    }

    @Override
    public List<String> expectedManifestFiles() {
        return List.of("*.csproj", "*.sln");
    }
    ...
    public int containerPort() {
        return service.getPort() != null ? service.getPort() : 80;
    }
